...
extension Query {
    ...
    func related<Child, Direction, Constraint>(_ keyPath: KeyPath<Entity, Relation<Child, Direction, RelationKind.ToOne, Constraint>>) -> Query<Child>? {
        repository
    ...
    func related<Child, Direction, Constraint>(_ keyPath: KeyPath<Entity, Relation<Child, Direction, RelationKind.ToMany, Constraint>>) -> [Query<Child>] {
        repository
            .findRelations(for: Entity.self, relationName: keyPath.relationName, id: id)
...
extension Collection {
    ...
    func related<Entity, Child, Direction, Constraint>(
        _ keyPath: KeyPath<Entity, Relation<Child, Direction, RelationKind.ToOne, Constraint>>) -> [Query<Child>]
    ...
    func related<Entity, Child, Direction, Constraint>(
        _ keyPath: KeyPath<Entity, Relation<Child, Direction, RelationKind.ToMany, Constraint>>) -> [[Query<Child>]]
