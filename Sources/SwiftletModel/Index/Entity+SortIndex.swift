...
extension EntityModelProtocol {
    ...
    where T: Comparable {
        var index = context.index(indexType, keyPath) ??
             SortIndex<Self>.ComparableValue(name: .indexName(indexType, keyPath))
          ...
          T1: Comparable
    {
        var index = context.index(indexType, kp0, kp1) ??
            SortIndex<Self>.ComparableValue(name: .indexName(indexType, kp0, kp1))
          ...
          T2: Comparable
    {
        var index = context.index(indexType, kp0, kp1, kp2) ??
            SortIndex<Self>.ComparableValue(name: .indexName(indexType, kp0, kp1, kp2))
        try index.add(self,
          ...
          T3: Comparable
    {
        var index = context.index(indexType, kp0, kp1, kp2, kp3) ??
                SortIndex<Self>.ComparableValue(name: .indexName(indexType, kp0, kp1, kp2, kp3))
