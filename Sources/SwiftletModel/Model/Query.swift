...
public extension Collection {
          ...
          T1: Comparable
    {
        ...
        guard let index = context.index(.sort, kp0, kp1) else {
          ...
          T2: Comparable
    {
        ...
        guard let index = context.index(.sort, kp0, kp1, kp2) else {
          ...
          T3: Comparable
    {
        ...
        guard let index = context.index(.sort, kp0, kp1, kp2, kp3) else {
